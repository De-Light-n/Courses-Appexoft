# 🔧 Гіт та інше — Git та якість коду

> ℹ️ Це **допоміжний розділ** (не пронумерований модуль): інструменти, потрібні паралельно
> з усіма модулями. Основну нумеровану програму див. у Модулях 1–4.
